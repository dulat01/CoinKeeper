...
const ExpenseChart = ({ period, dateRange }) => {
  ...
  const prepareChartData = () => {
    // Фильтруем только расходы по выбранному периоду
    ...
    const data = Object.entries(expensesByCategory).map(([categoryId, value]) => ({
    ...
    // Сортируем по размеру расходов от большего к меньшему
